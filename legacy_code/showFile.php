...
<head>
  ...
  <title>ProVinc Buchhaltung - Dateiansicht</title>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <?php
        if (isset($_GET['weekStatId'])){
          $image = "./lieferscheine/lieferschein_".$_GET['weekStatId']."_".$_GET['number'].".jpg";
          $imageData = base64_encode(file_get_contents($image));
          echo '<img class="mx-auto d-block img-fluid" src="data:image/jpeg;base64,'.$imageData.'">';
        }else{
          echo "<h1 class='mb-4 text-alert'>Nichts anzuzeigen</h1>";
        }
        ?>
