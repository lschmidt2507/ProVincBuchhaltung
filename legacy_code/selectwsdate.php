...
<head>
  ...
  <title>ProVinc Buchhaltung - WS Zeitraum auswählen</title>
      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="wsnew.php">Neue Wochenstatistik</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <?php 
            $startDate = date_create_from_format("Y\-m\-d",$lastWS['endDate'])->modify('+1 day')->format("Y\-m\-d");
            $endDate = date("Y\-m\-d");
          ?>
          <h1 class="mb-4 text-alert">Daten für neue Wochenstatistik</h1>
          <form method="POST" action="wsnew.php">
            <div class="row">
              <div class="col-md-12">
                <div class="card shadow mb-4">
                  <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Daten</h6>
                  </div>
                  <div class="card-body">  
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <input type="hidden" value="<?php echo $startDate?>" name="startDay" required>
                      </div>
                      <div class="col-sm-6">
                        <label>Endtag</label>
                        <input type="date" value="<?php echo $endDate?>" class="form-control form-control-user" name="endDay" required>
                      </div>
                    </div>
                    <hr>
                    <div class="row justify-content-md-center">
                      <div class="col-md-4">
                        <input class="btn btn-secondary btn-user btn-block" type="submit" name="submit" value="Weiter">
                      </div> 
                    </div>
                  </div>
                </div>
