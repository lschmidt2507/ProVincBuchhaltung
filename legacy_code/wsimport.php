...
if(isset($_POST['productnum'])){
  ...
  $sql = "INSERT INTO `week_stats` (`startDate`, `endDate`, `coinsRegister`, `billsRegister`, `coinsTransfer`, `billsTransfer`, `author`, `profit`, `diff`, `id`) 
  VALUES ('".$_POST['startDay']."', '".$_POST['endDay']."', '".$_POST['coinsBegin']."', '".$_POST['billsBegin']."', '".$_POST['coinsTransfer']."', '".$_POST['billsTransfer']."', '".$_POST['creator']."', '".$_POST['profit']."', '".$_POST['diff']."','NULL')";
  ...
  for($count=0;$count<$_POST['productnum'];$count++){
    $sql = "INSERT INTO `sales` (`startDate`, `endDate`, `productId`, `bestBefore`, `bestAfter`, `countSold`, `EK`, `VK`, `profit`, `weekStatId`) 
    VALUES ('".$_POST['startDay']."', '".$_POST['endDay']."', '".$_POST['productID'.$count]."', '".$_POST['BestVorher'.$count]."', '".$_POST['BestNachher'.$count]."', '".$_POST['amount'.$count]."', '".$_POST['EK'.$count]."', '".$_POST['VK'.$count]."', '".$_POST['profit'.$count]."', '".$statId."')";
    mysqli_query($connection, $sql);
  }
}
?>
...
<head>
  ...
  <title>ProVinc Buchhaltung - Wochenstatisiken Import</title>
      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="wsimport.php">Import</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="mb-4 text-alert">Import</h1>

            <div class="card shadow mb-4">
              <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Wochenstatistiken importieren</h6>
              </div>
              <div class="card-body">
                <form action="POST" action="wsoverview.php">
                  <input type="file" id="file" class="form-control form-control-user filesInput" name="WSfiles" required multiple>
                  <label class="btn btn-primary" for="file">JSON-Dateien auswählen</label>
                  <table id="dataTable" class="table table-striped table-bordered display" style="width:100%">
                    <thead>
                      <tr>
                        <th>Dateiname</th>
                        <th>Dateityp(muss JSON sein)</th>
                      </tr>
                    </thead>
                    <tbody id="showFiles">
                    </tbody>
                  ...
                  <hr/>
                  <input class="btn btn-secondary btn-user btn-block" id="fileButton" type="submit" name="submit" value="Importieren">
                </form>
              </div>
            </div>
