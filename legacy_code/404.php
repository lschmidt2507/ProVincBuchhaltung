...
<head>
  ...
  <title>ProVinc Buchhaltung - Seite nicht gefunden</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="wsoverview.php" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="text-center">
          ...
          <p class="lead text-gray-800 mb-5">Diese Seite ist entweder noch nicht fertig, oder es gibt sie garnicht!</p>
          <p class="text-gray-500 mb-0">Bitte gehe zu einer anderen Seite weiter!</p>
          <a href="index.php">&larr; Zurück zur Startseite</a>
        </div>
